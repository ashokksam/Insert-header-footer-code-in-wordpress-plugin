...
<div class="notice notice-success is-dismissible <?php echo $this->plugin->name; ?>-notice-welcome">
	<p>
		...
		printf(
			...
			__( 'Thank you for installing %1$s!', 'asm-insert-headers-and-footers' ),
			$this->plugin->displayName
		);
		?>
		<a href="<?php echo $setting_page; ?>"><?php esc_html_e( 'Click here', 'asm-insert-headers-and-footers' ); ?></a> <?php esc_html_e( 'to configure the plugin.', 'asm-insert-headers-and-footers' ); ?>
	</p>
</div>
